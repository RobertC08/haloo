...
// Use custom header for category pages
get_header();
?>

<!-- CSS moved to external file: assets/css/pages/category.css -->
    ...
    <div class="blog-container">
        ...
        <div class="blog-header">
            ...
            <?php if (category_description()) : ?>
                <p class="blog-subtitle"><?php echo strip_tags(category_description()); ?></p>
            <?php endif; ?>
        </div>
        ...
        <aside class="blog-sidebar">
                ...
                <div class="sidebar-widget sidebar-categories">
                    <h3 class="sidebar-widget-title" onclick="toggleAccordion(this)">CAUTĂ</h3>
            ...
            <div class="blog-posts">
                ...
                ?>
                    <div class="no-posts">
                        <h3>Nu există articole în această categorie</h3>
                        <p>Încă nu am publicat articole în categoria <?php single_cat_title(); ?>. Revino în curând pentru conținut nou!</p>
